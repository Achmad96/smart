...
export default function DeleteTemplateButton({ id }: { id: string }) {
  ...
  return (
    <button onClick={handleDelete} disabled={isDeleting} className="p-2 rounded-lg text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 transition-colors" title="Hapus Templat">
      {isDeleting ? (
